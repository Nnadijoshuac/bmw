...
export default function Navbar() {
  return (
    <motion.nav
      ...
      className="absolute left-4 right-4 top-4 z-30 flex items-center justify-between rounded-full border border-white/60 bg-white/40 px-4 py-3 backdrop-blur md:left-16 md:right-16 md:top-8"
    >
